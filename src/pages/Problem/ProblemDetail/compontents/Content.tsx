  ...
  return (
    <div className={catalog}>
      ...
      <Space size="small" style={{ margin: '8px 0' }}>
        <span style={{ color: difficultyColor, paddingRight: 8 }}>{problem.difficulty}</span>
        ...
        {/*<span style={{ color: difficultyColor, paddingRight: 8 }}>{"提交数 : " + problem.submitNum}</span>*/}

        {/*<span style={{ color: difficultyColor, paddingRight: 8 }}>{"通过数 : " + problem.acceptedNum}</span>*/}
